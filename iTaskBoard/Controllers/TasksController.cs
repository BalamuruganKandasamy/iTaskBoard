...
namespace iTaskBoard.Controllers
{
    ...
    public class TasksController : Controller
    {
        ...
        public IActionResult Create(TaskFormModel taskModel)
        {
            ...
            iTaskBoard.Data.Task task = new iTaskBoard.Data.Task()
            {
        ...
        {
            iTaskBoard.Data.Task task = dbContext.Tasks.Find(id);
            if (task == null)
            {
        ...
        {
            iTaskBoard.Data.Task task = dbContext.Tasks.Find(taskModel.Id);
            if (task == null)
            {
                return BadRequest();
            }
